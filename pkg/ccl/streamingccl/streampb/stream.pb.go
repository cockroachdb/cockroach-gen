...
type StreamIngestionStats_ReplicationLagInfo struct {
	...
	FastestSourcePartition          string        `protobuf:"bytes,3,opt,name=fastest_source_partition,json=fastestSourcePartition,proto3" json:"fastest_source_partition,omitempty"`
	FastestSourcePartitionTimestamp hlc.Timestamp `protobuf:"bytes,4,opt,name=fastest_source_partition_timestamp,json=fastestSourcePartitionTimestamp,proto3" json:"fastest_source_partition_timestamp"`
	SlowestSourcePartition          string        `protobuf:"bytes,5,opt,name=slowest_source_partition,json=slowestSourcePartition,proto3" json:"slowest_source_partition,omitempty"`
	SlowestSourcePartitionTimestamp hlc.Timestamp `protobuf:"bytes,6,opt,name=slowest_source_partition_timestamp,json=slowestSourcePartitionTimestamp,proto3" json:"slowest_source_partition_timestamp"`
	// Lag between the slowest ingested timestamp to the fastest ingested timestamp
	// among all partitions.
	SlowestFastestPartitionIngestionLag time.Duration `protobuf:"bytes,7,opt,name=slowest_fastest_partition_ingestion_lag,json=slowestFastestPartitionIngestionLag,proto3,stdduration" json:"slowest_fastest_partition_ingestion_lag"`
}
...
func (*StreamIngestionStats_ReplicationLagInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_44eb106be4866a3a, []int{4, 0}
}
...
func init() {
	...
	proto.RegisterType((*StreamIngestionStats_ReplicationLagInfo)(nil), "cockroach.ccl.streamingccl.StreamIngestionStats.ReplicationLagInfo")
}
...
var fileDescriptor_44eb106be4866a3a = []byte{
	...
	,
}
...
func (m *StreamIngestionStats_ReplicationLagInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n16, err16 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.SlowestFastestPartitionIngestionLag, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.SlowestFastestPartitionIngestionLag):])
	if err16 != nil {
		return 0, err16
	}
	i -= n16
	i = encodeVarintStream(dAtA, i, uint64(n16))
	i--
	dAtA[i] = 0x3a
	{
		size, err := m.SlowestSourcePartitionTimestamp.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x32
	if len(m.SlowestSourcePartition) > 0 {
		i -= len(m.SlowestSourcePartition)
		copy(dAtA[i:], m.SlowestSourcePartition)
		i = encodeVarintStream(dAtA, i, uint64(len(m.SlowestSourcePartition)))
		i--
		dAtA[i] = 0x2a
	}
	{
		size, err := m.FastestSourcePartitionTimestamp.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x22
	if len(m.FastestSourcePartition) > 0 {
		i -= len(m.FastestSourcePartition)
		copy(dAtA[i:], m.FastestSourcePartition)
		i = encodeVarintStream(dAtA, i, uint64(len(m.FastestSourcePartition)))
		i--
		dAtA[i] = 0x1a
	}
	n19, err19 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.ReplicationLag, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.ReplicationLag):])
	if err19 != nil {
		return 0, err19
	}
	i -= n19
	i = encodeVarintStream(dAtA, i, uint64(n19))
	i--
	dAtA[i] = 0x12
	{
...
func (m *StreamIngestionStats_ReplicationLagInfo) Size() (n int) {
	...
	n += 1 + l + sovStream(uint64(l))
	l = len(m.FastestSourcePartition)
	if l > 0 {
		n += 1 + l + sovStream(uint64(l))
	}
	l = m.FastestSourcePartitionTimestamp.Size()
	n += 1 + l + sovStream(uint64(l))
	l = len(m.SlowestSourcePartition)
	if l > 0 {
		n += 1 + l + sovStream(uint64(l))
	}
	l = m.SlowestSourcePartitionTimestamp.Size()
	n += 1 + l + sovStream(uint64(l))
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.SlowestFastestPartitionIngestionLag)
	n += 1 + l + sovStream(uint64(l))
	return n
}
...
func (m *StreamIngestionStats_ReplicationLagInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FastestSourcePartition", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FastestSourcePartition = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FastestSourcePartitionTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FastestSourcePartitionTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlowestSourcePartition", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SlowestSourcePartition = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlowestSourcePartitionTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.SlowestSourcePartitionTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlowestFastestPartitionIngestionLag", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.SlowestFastestPartitionIngestionLag, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
