	...
	case types.TimestampTZFamily:
		...
		default:
			...
			case types.TimestampTZFamily:
				...
				case -1:
				default:
					probeKeys := vec.Timestamp()
					buildKeys := vec.Timestamp()
					if probeSel != nil {
						if probeVec.MaybeHasNulls() {
							if buildVec.MaybeHasNulls() {
								if ht.allowNullEquality {
	...
	case types.IntervalFamily:
		...
		default:
			...
			case types.IntervalFamily:
				...
				case -1:
				default:
					probeKeys := vec.Interval()
					buildKeys := vec.Interval()
					if probeSel != nil {
						if probeVec.MaybeHasNulls() {
							if buildVec.MaybeHasNulls() {
								if ht.allowNullEquality {
