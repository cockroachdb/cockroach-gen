...
func IsPrivateOp(e Expr) bool {
	...
	case AlterTableRelocatePrivateOp, AlterTableSplitPrivateOp, CancelPrivateOp, ControlJobsPrivateOp,
		...
		SequenceSelectPrivateOp, SetPrivateOp, ShowTracePrivateOp, SubqueryPrivateOp, UniqueChecksItemPrivateOp,
...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		RankOp, RegIMatchOp, RegMatchOp, RegressionCountOp, RegressionInterceptOp,
		RegressionR2Op, RegressionSXXOp, RegressionSXYOp, RegressionSYYOp, RegressionSlopeOp,
		RowNumberOp, STCollectOp, STExtentOp, STMakeLineOp, STUnionOp,
		...
		UniqueChecksOp, UniqueChecksItemOp, UnsupportedExprOp, VarPopOp, VariableOp,
...
func IsAggregateOp(e Expr) bool {
	...
	case AnyNotNullAggOp, ArrayAggOp, AvgOp, BitAndAggOp,
		...
		RegressionSYYOp, RegressionSlopeOp, STCollectOp, STExtentOp, STMakeLineOp,
