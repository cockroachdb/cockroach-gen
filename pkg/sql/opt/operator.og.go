...
func IsTelemetryOp(e Expr) bool {
	switch e.Op() {
	case AntiJoinApplyOp, DistinctOnOp, EnsureDistinctOnOp, GroupByOp,
		InnerJoinApplyOp, LeftJoinApplyOp, ProjectSetOp, ScalarGroupByOp, SemiJoinApplyOp,
		SortOp, UpsertDistinctOnOp, ZigzagJoinOp:
		return true
	}
	return false
}
...
func IsRelationalOp(e Expr) bool {
	...
	case AlterTableRelocateOp, AlterTableSplitOp, AlterTableUnsplitOp, AlterTableUnsplitAllOp,
		...
		FullJoinOp, GeoLookupJoinOp, GroupByOp, IndexJoinOp, InnerJoinOp,
...
func IsPrivateOp(e Expr) bool {
	...
	case AlterTableRelocatePrivateOp, AlterTableSplitPrivateOp, CancelPrivateOp, ControlJobsPrivateOp,
		...
		FakeRelPrivateOp, FunctionPrivateOp, GeoLookupJoinPrivateOp, GroupingPrivateOp, IndexJoinPrivateOp,
		...
		ShowTracePrivateOp, SubqueryPrivateOp, ValuesPrivateOp, WindowPrivateOp, WindowsItemPrivateOp,
...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		OrOp, OverlapsOp, PercentRankOp, PlaceholderOp, PlusOp,
		PowOp, ProjectionsOp, ProjectionsItemOp, RShiftOp, RangeOp,
		RankOp, RegIMatchOp, RegMatchOp, RowNumberOp, ScalarListOp,
		SimilarToOp, SqrDiffOp, StdDevOp, StringAggOp, SubqueryOp,
		SumOp, SumIntOp, TrueOp, TupleOp, UnaryCbrtOp,
		UnaryComplementOp, UnaryMinusOp, UnarySqrtOp, UnsupportedExprOp, VariableOp,
...
func IsGroupingOp(e Expr) bool {
	switch e.Op() {
	case DistinctOnOp, EnsureDistinctOnOp, GroupByOp, ScalarGroupByOp,
		UpsertDistinctOnOp:
		return true
	}
	return false
...
func IsAggregateOp(e Expr) bool {
	...
	case AnyNotNullAggOp, ArrayAggOp, AvgOp, BitAndAggOp,
		...
		StdDevOp, StringAggOp, SumOp, SumIntOp, VarianceOp,
		XorAggOp:
		return true
	}
	return false
