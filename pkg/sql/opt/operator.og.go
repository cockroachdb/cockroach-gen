...
func IsGroupingOp(e Expr) bool {
	switch e.Op() {
	case DistinctOnOp, GroupByOp, ScalarGroupByOp, UpsertDistinctOnOp:
		return true
	}
	return false
}
