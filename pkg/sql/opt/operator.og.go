...
func IsRelationalOp(e Expr) bool {
	...
	case AlterTableRelocateOp, AlterTableSplitOp, AlterTableUnsplitOp, AlterTableUnsplitAllOp,
		...
		LimitOp, LookupJoinOp, Max1RowOp, MergeJoinOp, OffsetOp,
		OpaqueDDLOp, OpaqueMutationOp, OpaqueRelOp, OrdinalityOp, ProjectOp,
		ProjectSetOp, RecursiveCTEOp, RightJoinOp, ScalarGroupByOp, ScanOp,
		SelectOp, SemiJoinOp, SemiJoinApplyOp, SequenceSelectOp, ShowTraceForSessionOp,
		UnionOp, UnionAllOp, UpdateOp, UpsertOp, UpsertDistinctOnOp,
		ValuesOp, WindowOp, WithOp, WithScanOp, ZigzagJoinOp:
		return true
	}
	return false
}
...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		RankOp, RegIMatchOp, RegMatchOp, RegressionAvgXOp, RegressionCountOp,
		...
		UnarySqrtOp, UniqueChecksOp, UniqueChecksItemOp, UnsupportedExprOp, VarPopOp,
...
func IsAggregateOp(e Expr) bool {
	...
	case AnyNotNullAggOp, ArrayAggOp, AvgOp, BitAndAggOp,
		...
		RegressionAvgXOp, RegressionCountOp, RegressionInterceptOp, RegressionR2Op, RegressionSXXOp,
		RegressionSXYOp, RegressionSYYOp, RegressionSlopeOp, STCollectOp, STExtentOp,
