...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		RegMatchOp, RowNumberOp, STExtentOp, STMakeLineOp, STUnionOp,
		ScalarListOp, SimilarToOp, SqrDiffOp, StdDevOp, StdDevPopOp,
		StringAggOp, SubqueryOp, SumOp, SumIntOp, TrueOp,
		TupleOp, UnaryCbrtOp, UnaryComplementOp, UnaryMinusOp, UnarySqrtOp,
		UnsupportedExprOp, VarPopOp, VariableOp, VarianceOp, WhenOp,
		WindowFromOffsetOp, WindowToOffsetOp, WindowsOp, WindowsItemOp, XorAggOp,
		ZipOp, ZipItemOp:
		return true
	}
	return false
...
func IsAggregateOp(e Expr) bool {
	...
	case AnyNotNullAggOp, ArrayAggOp, AvgOp, BitAndAggOp,
		...
		MinOp, PercentileContOp, PercentileDiscOp, STExtentOp, STMakeLineOp,
		STUnionOp, SqrDiffOp, StdDevOp, StdDevPopOp, StringAggOp,
		SumOp, SumIntOp, VarPopOp, VarianceOp, XorAggOp:
		return true
	}
	return false
}
