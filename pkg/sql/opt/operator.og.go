...
func IsRelationalOp(e Expr) bool {
	...
	case AlterTableRelocateOp, AlterTableSplitOp, AlterTableUnsplitOp, AlterTableUnsplitAllOp,
		...
		SemiJoinApplyOp, SequenceSelectOp, ShowTraceForSessionOp, UnionOp, UnionAllOp,
...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		UnaryComplementOp, UnaryMinusOp, UnarySqrtOp, UniqueChecksOp, UniqueChecksItemOp,
...
func IsCompositeInsensitiveOp(e Expr) bool {
	...
	case ContainedByOp, ContainsOp, DivOp, EqOp,
		...
		UnaryCbrtOp, UnaryMinusOp, UnarySqrtOp, VariableOp:
		return true
	}
	return false
}
