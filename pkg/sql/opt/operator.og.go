...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		UnaryCbrtOp, UnaryComplementOp, UnaryMinusOp, UnarySqrtOp, UniqueChecksOp,
		UniqueChecksItemOp, UnsupportedExprOp, VarPopOp, VariableOp, VarianceOp,
...
func IsAggregateOp(e Expr) bool {
	...
	case AnyNotNullAggOp, ArrayAggOp, AvgOp, BitAndAggOp,
		...
		RegressionSlopeOp, STCollectOp, STExtentOp, STMakeLineOp, STUnionOp,
