...
func _() {
	...
	_ = x[EliminateWindow-181]
	_ = x[ReduceWindowPartitionCols-182]
	_ = x[SimplifyWindowOrdering-183]
	_ = x[startExploreRule-184]
	_ = x[ReplaceMinWithLimit-185]
	_ = x[ReplaceMaxWithLimit-186]
	_ = x[GenerateStreamingGroupBy-187]
	_ = x[CommuteJoin-188]
	_ = x[CommuteLeftJoin-189]
	_ = x[CommuteRightJoin-190]
	_ = x[GenerateMergeJoins-191]
	_ = x[GenerateLookupJoins-192]
	_ = x[GenerateZigzagJoins-193]
	_ = x[GenerateInvertedIndexZigzagJoins-194]
	_ = x[GenerateLookupJoinsWithFilter-195]
	_ = x[AssociateJoin-196]
	_ = x[GenerateLimitedScans-197]
	_ = x[PushLimitIntoConstrainedScan-198]
	_ = x[PushLimitIntoIndexJoin-199]
	_ = x[GenerateIndexScans-200]
	_ = x[GenerateConstrainedScans-201]
	_ = x[GenerateInvertedIndexScans-202]
	_ = x[NumRuleNames-203]
}

const _RuleName_name = ""

var _RuleName_index = [...]uint16{0, 15, 35, 48, 76, 94, 114, 133, 148, 163, 179, 195, 209, 223, 238, 253, 266, 279, 290, 302, 318, 330, 339, 347, 371, 391, 413, 434, 456, 478, 500, 522, 545, 555, 572, 585, 605, 618, 633, 654, 674, 695, 722, 752, 775, 802, 823, 850, 872, 894, 918, 935, 955, 974, 994, 1011, 1030, 1053, 1077, 1099, 1126, 1151, 1163, 1176, 1194, 1213, 1231, 1246, 1264, 1273, 1283, 1292, 1306, 1314, 1329, 1345, 1357, 1381, 1398, 1421, 1439, 1466, 1494, 1516, 1537, 1560, 1584, 1614, 1636, 1655, 1678, 1708, 1729, 1751, 1773, 1796, 1826, 1857, 1884, 1912, 1929, 1946, 1969, 1993, 2014, 2034, 2061, 2082, 2099, 2113, 2133, 2154, 2170, 2182, 2194, 2207, 2218, 2229, 2239, 2250, 2269, 2290, 2312, 2335, 2361, 2384, 2400, 2413, 2435, 2451, 2464, 2479, 2493, 2508, 2525, 2543, 2555, 2571, 2586, 2605, 2621, 2640, 2661, 2681, 2703, 2725, 2744, 2764, 2782, 2792, 2804, 2821, 2837, 2850, 2866, 2876, 2896, 2918, 2940, 2960, 2984, 3005, 3031, 3053, 3075, 3086, 3112, 3133, 3157, 3182, 3197, 3209, 3230, 3250, 3288, 3327, 3349, 3372, 3393, 3415, 3436, 3458, 3473, 3498, 3520, 3536, 3555, 3574, 3598, 3609, 3624, 3640, 3658, 3677, 3696, 3728, 3757, 3770, 3790, 3818, 3840, 3858, 3882, 3908, 3920}
