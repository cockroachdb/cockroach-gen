...
func (e *RegressionAvgYExpr) ID() opt.ScalarID {
	return e.id
}
...
func (e *RegressionInterceptExpr) ID() opt.ScalarID {
	return e.id
}
...
func (e *RegressionR2Expr) ID() opt.ScalarID {
	return e.id
}
...
func (e *RegressionSlopeExpr) ID() opt.ScalarID {
	return e.id
}
