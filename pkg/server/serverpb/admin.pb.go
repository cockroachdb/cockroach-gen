...
func (x DecommissionPreCheckResponse_NodeReadiness) String() string {
	return proto.EnumName(DecommissionPreCheckResponse_NodeReadiness_name, int32(x))
}
...
type DecommissionPreCheckResponse_NodeCheckResult struct {
	...
	LivenessStatus livenesspb.NodeLivenessStatus `protobuf:"varint,3,opt,name=liveness_status,json=livenessStatus,proto3,enum=cockroach.kv.kvserver.liveness.livenesspb.NodeLivenessStatus" json:"liveness_status,omitempty"`
...
type RecoveryStagePlanRequest struct {
	...
	// Force plan tells receiver to ignore any plan already staged on the node if it
...
type RecoveryNodeStatusResponse struct {
	Status *loqrecoverypb.NodeRecoveryStatus `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
}
...
type RecoveryVerifyResponse struct {
	...
	Statuses []*loqrecoverypb.NodeRecoveryStatus `protobuf:"bytes,1,rep,name=statuses,proto3" json:"statuses,omitempty"`
	// Unavailable ranges contains descriptors of ranges that failed health checks.
	UnavailableRanges []*roachpb.RangeDescriptor `protobuf:"bytes,2,rep,name=unavailable_ranges,json=unavailableRanges,proto3" json:"unavailable_ranges,omitempty"`
...
var fileDescriptor_0b2ccb6a0551fa7e = []byte{
	// 6859 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *DecommissionPreCheckResponse_NodeCheckResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LivenessStatus != 0 {
		i = encodeVarintAdmin(dAtA, i, uint64(m.LivenessStatus))
		i--
		dAtA[i] = 0x18
	}
...
func (m *RecoveryVerifyRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DecommissionedNodeIDs) > 0 {
		dAtA50 := make([]byte, len(m.DecommissionedNodeIDs)*10)
		var j49 int
		...
		i = encodeVarintAdmin(dAtA, i, uint64(j49))
		i--
		dAtA[i] = 0x12
	}
...
func (m *RecoveryVerifyResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.DecommissionedNodeIDs) > 0 {
		dAtA52 := make([]byte, len(m.DecommissionedNodeIDs)*10)
		var j51 int
		for _, num1 := range m.DecommissionedNodeIDs {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintAdmin(dAtA, i, uint64(j51))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.UnavailableRanges) > 0 {
		for iNdEx := len(m.UnavailableRanges) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UnavailableRanges[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TracingSpan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n58, err58 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Start, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.Start):])
	if err58 != nil {
		return 0, err58
	}
	i -= n58
	i = encodeVarintAdmin(dAtA, i, uint64(n58))
	i--
	dAtA[i] = 0x2a
	if m.ParentSpanID != 0 {
...
func (m *DecommissionPreCheckResponse_NodeCheckResult) Size() (n int) {
	...
	if m.LivenessStatus != 0 {
		n += 1 + sovAdmin(uint64(m.LivenessStatus))
	}
	if m.ReplicaCount != 0 {
		n += 1 + sovAdmin(uint64(m.ReplicaCount))
	}
...
func (m *RecoveryVerifyResponse) Size() (n int) {
	...
	if len(m.UnavailableRanges) > 0 {
		for _, e := range m.UnavailableRanges {
			l = e.Size()
			n += 1 + l + sovAdmin(uint64(l))
		}
	}
...
func (m *DecommissionPreCheckResponse_NodeCheckResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LivenessStatus", wireType)
			}
			m.LivenessStatus = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LivenessStatus |= livenesspb.NodeLivenessStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *RecoveryNodeStatusResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Status == nil {
				m.Status = &loqrecoverypb.NodeRecoveryStatus{}
			}
...
func (m *RecoveryVerifyResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.UnavailableRanges = append(m.UnavailableRanges, &roachpb.RangeDescriptor{})
			if err := m.UnavailableRanges[len(m.UnavailableRanges)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
